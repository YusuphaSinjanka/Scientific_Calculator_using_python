...
# Label
data = StringVar()
disp = Entry(root, font="Verdana 20", fg="black", bg="white", bd=4, justify=RIGHT, insertbackground="#abbab1",
             cursor="arrow")
...
conv_btn = Button(btnrow3, text="Deg", font="Segoe 12 bold", relief=GROOVE, bd=0, command=conv_clicked, fg="white",
                  bg="#00CDFE")
